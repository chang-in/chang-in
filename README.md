...
## 🛠 나의 장점들
- <img src="https://em-content.zobj.net/source/animated-noto-color-emoji/427/sparkles_2728.gif" style="width : 10px; height:10px;">**군 복무 중에도 멈추지 않는 실행력**: 제한된 환경과 시간 속에서도 아이디어를 실제 서비스로 구현하여 출시하였습니다. 단순히 개발에 그치지 않고 실사용자가 이용하는 제품을 안정적으로 운영하고 있습니다.
